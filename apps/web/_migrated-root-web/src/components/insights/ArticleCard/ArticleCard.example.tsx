...
export const WellnessArticle = () => {
  const article: ArticleData = {
    ...
    coverImage: 'https://media.vitalicesf.com/insights/healthy-habits.jpg',
...
export const RecoveryGuide = () => {
  const article: ArticleData = {
    ...
    coverImage: 'https://media.vitalicesf.com/insights/sauna-protocol.jpg',
...
export const CommunityStory = () => {
  const article: ArticleData = {
    ...
    coverImage: 'https://media.vitalicesf.com/insights/member-journey.jpg',
...
export const ArticleWithAuthorObject = () => {
  const article: ArticleData = {
    ...
    author: {
      ...
      avatar: 'https://media.vitalicesf.com/authors/emily-rodriguez.jpg',
    },
    publishDate: '2025-01-12',
    coverImage: 'https://media.vitalicesf.com/insights/neuroscience-cold.jpg',
...
export const ArticleWithFewTags = () => {
  const article: ArticleData = {
    ...
    coverImage: 'https://media.vitalicesf.com/insights/quick-recovery.jpg',
    tags: ['Quick Tips'],
...
export const ArticleGrid = () => {
  const articles: ArticleData[] = [
    ...
    },
    {
      ...
      author: 'Marcus Thompson',
      publishDate: '2025-01-10',
      coverImage: 'https://media.vitalicesf.com/insights/sauna-practice.jpg',
    ...
    },
    {
      ...
      abstract: 'After years of pushing through pain, I discovered Vital Ice...',
      category: 'Community Story',
      author: 'Alex Rivera',
      publishDate: '2025-01-05',
      coverImage: 'https://media.vitalicesf.com/insights/member-story.jpg',
      tags: ['Member Story', 'Recovery', 'Transformation'],
