...
const sampleArticle: ArticleData = {
  ...
  content: `
    ...
    <figure>
      <img 
        ...
        alt="Person experiencing cold plunge therapy at Premium Service Business" 
      />
      <figcaption>Cold plunge therapy session — template illustration</figcaption>
    </figure>
    ...
    <p>
      Visit <a href="https://www.example.com">Premium Service Business</a> to experience professional cold plunge 
  ...
  pdfUrl: 'https://example.org/sample-document.pdf',
  readingTime: 8,
};
