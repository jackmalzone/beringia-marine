...
interface ArticlePdfButtonProps {
  pdfUrl: string;
  title: string;
}

export default function ArticlePdfButton({ pdfUrl, title }: ArticlePdfButtonProps) {
  ...
  return (
    <button
      ...
      className={styles.content__pdfButton}
      aria-label={`Download ${title} as PDF`}
    >
      <svg
        className={styles.content__pdfIcon}
        width="20"
        height="20"
        viewBox="0 0 20 20"
        fill="none"
