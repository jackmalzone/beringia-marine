/**
 * Static Beringia insights catalogue (data only, no `@/` aliases).
 *
 * Decoupled from `./insights.ts` so the migration seed script under
 * apps/studio can import the same array without depending on the apps/web
...
export const INSIGHTS: InsightEntry[] = [
  {
    ...
    sections: [],
    pdfUrl:
      '/assets/clients/anchor-bot/2025-TEAMER-HA-Install-Pull-Test-Report/' +
      encodeURIComponent(
        '2025 AnchorBot TEAMER HA Install & Pull Test Report v2600406.docx - Google Docs.pdf'
      ),
    seo: {
      title:
  ...
  },
  {
    ...
    sections: [],
    pdfUrl:
      '/assets/clients/mission-robotics/MR_From-Fragmented-Integration-to-Scalable-Control-Platforms/MR_From-Fragmented-Integration-to-Scalable-Control-Platforms.pdf',
    seo: {
      title:
