# Terms & Conditions — extracted copy

**Source:** `src/app/terms/page.tsx`  
**Staging only**

**Document title (page H2):** Terms & Conditions
...
> **Copy note:** Original uses "sall" — likely "shall"; legal review in Phase 2.
...
## Footer metadata (terms page)

- **Version:** Ver 240913_1
